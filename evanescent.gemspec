Gem::Specification.new do |s|
  ...
  s.description = "This gem provides an IO like object, that can be used with any logging class (such as Ruby's native Logger). This object will save its input to a file, and allows:
